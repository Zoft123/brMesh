...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    public static Snackbar make(View view, CharSequence charSequence, int i) {
        ...
        SnackbarContentLayout snackbarContentLayout = (SnackbarContentLayout) LayoutInflater.from(viewGroupFindSuitableParent.getContext()).inflate(hasSnackbarContentStyleAttrs(viewGroupFindSuitableParent.getContext()) ? R.layout.mtrl_layout_snackbar_include : R.layout.design_layout_snackbar_include, viewGroupFindSuitableParent, false);
