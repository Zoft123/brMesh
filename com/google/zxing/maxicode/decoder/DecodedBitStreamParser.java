...
final class DecodedBitStreamParser {
    ...
    private static final byte[] POSTCODE_2_BYTES = {33, 34, 35, 36, 25, 26, 27, 28, 29, 30, 19, 20, 21, 22, 23, 24, BSON.CODE, BSON.SYMBOL, BSON.CODE_W_SCOPE, BSON.NUMBER_INT, BSON.TIMESTAMP, BSON.NUMBER_LONG, 7, 8, 9, 10, BSON.REGEX, BSON.REF, 1, 2};
    private static final byte[][] POSTCODE_3_BYTES = {new byte[]{39, 40, 41, 42, 31, 32}, new byte[]{33, 34, 35, 36, 25, 26}, new byte[]{27, 28, 29, 30, 19, 20}, new byte[]{21, 22, 23, 24, BSON.CODE, BSON.SYMBOL}, new byte[]{BSON.CODE_W_SCOPE, BSON.NUMBER_INT, BSON.TIMESTAMP, BSON.NUMBER_LONG, 7, 8}, new byte[]{9, 10, BSON.REGEX, BSON.REF, 1, 2}};
        ...
        while (i3 < i + i2) {
            ...
            switch (cCharAt) {
                ...
                default:
                    ...
                    break;
                case 65531:
                    int i7 = (bArr[i3 + 1] << 24) + (bArr[i3 + 2] << BSON.NUMBER_LONG) + (bArr[i3 + 3] << BSON.REF) + (bArr[i3 + 4] << 6);
                    i3 += 5;
