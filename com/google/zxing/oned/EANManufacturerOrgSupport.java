...
final class EANManufacturerOrgSupport {
    ...
    private synchronized void initIfNeeded() {
        if (this.ranges.isEmpty()) {
            ...
            add(new int[]{60, GattError.GATT_INVALID_CFG}, "US/CA");
            ...
            add(new int[]{478}, "UZ");
            add(new int[]{479}, "LK");
            add(new int[]{CodeUtils.DEFAULT_REQ_WIDTH}, "PH");
            add(new int[]{481}, "BY");
            add(new int[]{482}, "UA");
            add(new int[]{484}, "MD");
            add(new int[]{485}, "AM");
            ...
            add(new int[]{DisDoubleClickListener.MIN_CLICK_DELAY_TIME, 509}, "GB");
            add(new int[]{520}, "GR");
            ...
            add(new int[]{628}, "SA");
            add(new int[]{629}, "AE");
            add(new int[]{CodeUtils.DEFAULT_REQ_HEIGHT, 649}, "FI");
            add(new int[]{690, 695}, "CN");
            add(new int[]{TypedValues.TransitionType.TYPE_DURATION, 709}, "NO");
            add(new int[]{729}, "IL");
