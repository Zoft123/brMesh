...
public abstract class BaseCameraScanFragment<T> extends Fragment implements CameraScan.OnScanResultCallback<T> {
            ...
            if (viewFindViewById != null) {
                viewFindViewById.setOnClickListener(new View.OnClickListener() { // from class: com.king.camera.scan.BaseCameraScanFragment$$ExternalSyntheticLambda0
                    ...
                    public final void onClick(View view) {
                        this.f$0.m1248lambda$initUI$0$comkingcamerascanBaseCameraScanFragment(view);
                    }
                });
            }
        }
    ...
    /* JADX INFO: renamed from: lambda$initUI$0$com-king-camera-scan-BaseCameraScanFragment, reason: not valid java name */
    /* synthetic */ void m1248lambda$initUI$0$comkingcamerascanBaseCameraScanFragment(View view) {
        onClickFlashlight();
    }
