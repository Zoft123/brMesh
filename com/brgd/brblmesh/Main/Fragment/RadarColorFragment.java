...
public class RadarColorFragment extends Fragment implements SeekBar.OnSeekBarChangeListener, ColorObserver, ColorWheelView.OnSetColorListener, ColourFragmentListener, View.OnClickListener {
    ...
    private final DisDoubleClickListener disDoubleClickListener = new DisDoubleClickListener() { // from class: com.brgd.brblmesh.Main.Fragment.RadarColorFragment.1
        @Override // com.brgd.brblmesh.GeneralClass.DisDoubleClickListener
        protected void disDoubleClick(View view) {
            int id = view.getId();
            if (id == R.id.colour_toRightBt) {
                if (RadarColorFragment.this.currentColor != -1) {
                    RadarColorFragment.this.colorWheelView.moveSelector(false);
                    return;
                }
                return;
            }
            if (id == R.id.colour_toLeftBt) {
                if (RadarColorFragment.this.currentColor != -1) {
                    RadarColorFragment.this.colorWheelView.moveSelector(true);
                    return;
                }
                return;
            }
            if (id == R.id.colour_on || id == R.id.colour_topOn) {
                RadarColorFragment.this.onOffClick(true);
                return;
            }
            if (id == R.id.colour_off || id == R.id.colour_topOff) {
                RadarColorFragment.this.onOffClick(false);
                return;
            }
            if (id == R.id.colour_temp_up) {
                if (RadarColorFragment.this.currentTempProgress > 0) {
                    RadarColorFragment.this.currentTempProgress--;
                }
                RadarColorFragment.this.tempSeekBar.setProgress(100 - RadarColorFragment.this.currentTempProgress);
                RadarColorFragment.this.setColorTemp();
                return;
            }
            if (id == R.id.colour_temp_up1) {
                ...
                RadarColorFragment.this.tempSeekBar1.setProgress(100 - RadarColorFragment.this.currentTempProgress);
                RadarColorFragment.this.setColorTemp();
                if (RadarColorFragment.this.currentMyColorTempSelector != null) {
                    RadarColorFragment.this.currentMyColorTempSelector.setBorderSelectorColor(0);
                    RadarColorFragment.this.currentMyColorTempSelector = null;
                }
                if (RadarColorFragment.this.currentDiyColorTempSelector != null) {
                    DiyColor diyColor = (DiyColor) RadarColorFragment.this.diyColorTempList.get(RadarColorFragment.this.currentDiyColorTempIndex);
                    RadarColorFragment.this.realm.beginTransaction();
                    diyColor.setColorValue(RadarColorFragment.this.currentTempProgress);
                    RadarColorFragment.this.realm.commitTransaction();
                    RadarColorFragment.this.diyColorTempAdapter.notifyDataSetChanged();
                    return;
                }
                return;
            }
            if (id == R.id.colour_temp_down) {
                if (RadarColorFragment.this.currentTempProgress < 100) {
                    RadarColorFragment.this.currentTempProgress++;
                }
                RadarColorFragment.this.tempSeekBar.setProgress(100 - RadarColorFragment.this.currentTempProgress);
                RadarColorFragment.this.setColorTemp();
            ...
            if (id == R.id.colour_temp_down1) {
                ...
                if (RadarColorFragment.this.currentDiyColorTempSelector != null) {
                    DiyColor diyColor2 = (DiyColor) RadarColorFragment.this.diyColorTempList.get(RadarColorFragment.this.currentDiyColorTempIndex);
                    RadarColorFragment.this.realm.beginTransaction();
                    diyColor2.setColorValue(RadarColorFragment.this.currentTempProgress);
                    RadarColorFragment.this.realm.commitTransaction();
                    RadarColorFragment.this.diyColorTempAdapter.notifyDataSetChanged();
                    return;
                }
            ...
            if (id == R.id.colour_brightness_up) {
                if (RadarColorFragment.this.currentBrightnessProgress < 100) {
                    RadarColorFragment.this.currentBrightnessProgress++;
                }
                RadarColorFragment.this.brightnessSeekBar.setProgress(RadarColorFragment.this.currentBrightnessProgress - 1);
                RadarColorFragment.this.setLightness();
                return;
            }
            if (id == R.id.colour_brightness_up1) {
                ...
                RadarColorFragment.this.brightnessSeekBar1.setProgress(RadarColorFragment.this.currentBrightnessProgress - 1);
                RadarColorFragment.this.setLightness();
                return;
            }
            if (id == R.id.colour_brightness_down) {
                if (RadarColorFragment.this.currentBrightnessProgress > 1) {
                    RadarColorFragment.this.currentBrightnessProgress--;
                }
                RadarColorFragment.this.brightnessSeekBar.setProgress(RadarColorFragment.this.currentBrightnessProgress - 1);
                RadarColorFragment.this.setLightness();
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View viewInflate = layoutInflater.inflate(R.layout.fragment_radar_color, viewGroup, false);
    ...
    private void initView(View view) {
        int i;
        Realm.init(this.radarDvCtrlActivity.getApplicationContext());
        ...
        this.diyColorAdapter.setOnItemClickListener(new DiyColorAdapter.OnItemClickListener() { // from class: com.brgd.brblmesh.Main.Fragment.RadarColorFragment$$ExternalSyntheticLambda0
        ...
        this.myColorAdapter.setOnItemClickListener(new DiyColorAdapter.OnItemClickListener() { // from class: com.brgd.brblmesh.Main.Fragment.RadarColorFragment$$ExternalSyntheticLambda1
            @Override // com.brgd.brblmesh.GeneralAdapter.DiyColorAdapter.OnItemClickListener
            public final void OnItemClick(View view2, int i2) {
        ...
        this.coldText = (TextView) view.findViewById(R.id.colour_coldText);
        this.coldValue = (TextView) view.findViewById(R.id.colour_coldTextValue);
        ...
        this.coldText1 = (TextView) view.findViewById(R.id.colour_coldText1);
        this.coldValue1 = (TextView) view.findViewById(R.id.colour_coldTextValue1);
        ...
        this.diyColorTempAdapter.setOnItemClickListener(new ColorTempAdapter.OnItemClickListener() { // from class: com.brgd.brblmesh.Main.Fragment.RadarColorFragment$$ExternalSyntheticLambda2
        ...
        this.myColorTempAdapter.setOnItemClickListener(new DiyColorAdapter.OnItemClickListener() { // from class: com.brgd.brblmesh.Main.Fragment.RadarColorFragment$$ExternalSyntheticLambda3
            @Override // com.brgd.brblmesh.GeneralAdapter.DiyColorAdapter.OnItemClickListener
            public final void OnItemClick(View view2, int i7) {
        ...
        int iIntValue = ((Integer) SharePreferenceUtils.get(this.radarDvCtrlActivity, GlobalVariable.colorTempValue, Integer.valueOf(i))).intValue();
        ...
        int iIntValue2 = ((Integer) SharePreferenceUtils.get(this.radarDvCtrlActivity, GlobalVariable.colorValue, -65536)).intValue();
        this.currentColor = iIntValue2;
        if (iIntValue2 == -3) {
            this.colorWheelView.setColor(-1, false);
        } else {
            this.colorWheelView.setColor(iIntValue2, false);
        }
    ...
    private void handleViewVisibility() {
        if (this.radarDvCtrlActivity.viewType == 43169) {
        ...
        if (this.radarDvCtrlActivity.viewType == 43168) {
            this.tempSeekBar.setVisibility(8);
            this.warmValue.setVisibility(8);
            this.warmText.setVisibility(8);
            this.coldText.setVisibility(8);
        ...
        if (this.radarDvCtrlActivity.viewType == 43051 || this.radarDvCtrlActivity.viewType == 44601) {
        ...
        if (this.radarDvCtrlActivity.viewType == 43049) {
            this.colorPickerLayout.setVisibility(8);
            this.colorSeekBarLayout.setVisibility(8);
            this.scrollView.setVisibility(8);
            this.colorTempScrollView.setVisibility(0);
    ...
    public void OnSetColor(int i) {
        ...
        if (this.currentDiyColorSelector != null) {
    ...
    public void onStopTrackingTouch(SeekBar seekBar) {
        ...
        if (seekBar == this.tempSeekBar1) {
            ...
            if (this.currentDiyColorTempSelector != null) {
    ...
    public void setLightness() {
        ...
        SharePreferenceUtils.put(this.radarDvCtrlActivity, GlobalVariable.radarLightnessValue, Integer.valueOf(this.currentBrightnessProgress));
    }
    ...
    private void setRgbColor() {
        ...
        if (iRgb == -16777216) {
            ...
            SharePreferenceUtils.put(this.radarDvCtrlActivity, GlobalVariable.colorValue, Integer.valueOf(this.currentColor));
            return;
        }
        if (Tool.isRGBW(iRgb)) {
        ...
        this.colorWheelView.setColor1(iRgb, false);
        ColorSelector colorSelector4 = this.currentMyColorSelector;
        if (colorSelector4 != null && iRgb != colorSelector4.getCurrentSelectorColor()) {
            this.currentMyColorSelector.setBorderSelectorColor(0);
            this.currentMyColorSelector = null;
        }
        if (this.currentDiyColorSelector != null) {
    ...
    public void setColorTemp() {
        ...
        SharePreferenceUtils.put(this.radarDvCtrlActivity, GlobalVariable.radarColorTempValue, Integer.valueOf(this.currentTempProgress));
    }
}
