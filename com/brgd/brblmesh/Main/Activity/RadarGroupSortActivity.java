...
public class RadarGroupSortActivity extends FatherActivity implements MyItemTouchHelper.OnItemTouchListener {
    ImageView backView;
    ...
    private final DisDoubleClickListener disDoubleClickListener = new DisDoubleClickListener() { // from class: com.brgd.brblmesh.Main.Activity.RadarGroupSortActivity.1
        @Override // com.brgd.brblmesh.GeneralClass.DisDoubleClickListener
        protected void disDoubleClick(View view) {
            if (view.getId() == R.id.group_sort_back) {
                RadarGroupSortActivity.this.finish();
            }
        }
    };
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.activity_radar_group_sort);
        initView();
    }
    ...
    public boolean onMove(int i, int i2) {
        ...
        this.radarGrouplistAdapter.notifyItemMoved(i, i2);
        RadarGroup radarGroup = this.groupsList.get(i);
        int index = radarGroup.getIndex();
        RadarGroup radarGroup2 = this.groupsList.get(i2);
        int index2 = radarGroup2.getIndex();
        this.realm.beginTransaction();
        radarGroup.setIndex(index2);
        radarGroup2.setIndex(index);
