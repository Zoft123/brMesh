...
public class RadarDvSortAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public RadarDvSortAdapter(Context context, List<RadarDevice> list) {
        this.list = list;
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        viewHolder.deleteView.setOnClickListener(new DisDoubleClickListener() { // from class: com.brgd.brblmesh.GeneralAdapter.RadarDvSortAdapter.1
            @Override // com.brgd.brblmesh.GeneralClass.DisDoubleClickListener
            protected void disDoubleClick(View view) {
                if (RadarDvSortAdapter.this.onItemClickListener != null) {
                    RadarDvSortAdapter.this.onItemClickListener.onClick(view, ((Integer) view.getTag()).intValue());
                }
            }
        });
    }
