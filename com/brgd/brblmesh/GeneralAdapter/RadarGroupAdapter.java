...
public class RadarGroupAdapter extends RecyclerView.Adapter<ViewHolder> {
    private final Context context;
    private final List<RadarGroup> list;
    ...
    public RadarGroupAdapter(Context context, List<RadarGroup> list) {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        viewHolder.itemView.setOnClickListener(new DisDoubleClickListener() { // from class: com.brgd.brblmesh.GeneralAdapter.RadarGroupAdapter.1
            @Override // com.brgd.brblmesh.GeneralClass.DisDoubleClickListener
            protected void disDoubleClick(View view) {
                if (RadarGroupAdapter.this.onItemButtonClickListener != null) {
                    RadarGroupAdapter.this.onItemButtonClickListener.OnItemButtonClick(view, ((Integer) view.getTag()).intValue());
                }
            }
        });
    }
