...
public abstract class Request {
    ...
    public Request setHandler(final Handler handler) {
        this.handler = new CallbackHandler() { // from class: com.brgd.brblmesh.GeneralClass.ble.bleTool.Request.1
    ...
    void notifyStarted(final BluetoothDevice bluetoothDevice) {
        ...
        this.handler.post(new Runnable() { // from class: com.brgd.brblmesh.GeneralClass.ble.bleTool.Request$$ExternalSyntheticLambda1
    ...
    boolean notifySuccess(final BluetoothDevice bluetoothDevice) {
        ...
        this.handler.post(new Runnable() { // from class: com.brgd.brblmesh.GeneralClass.ble.bleTool.Request$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
    ...
    void notifyFail(final BluetoothDevice bluetoothDevice, final int i) {
        ...
        this.handler.post(new Runnable() { // from class: com.brgd.brblmesh.GeneralClass.ble.bleTool.Request$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
    ...
    void notifyInvalidRequest() {
        ...
        this.finished = true;
        this.handler.post(new Runnable() { // from class: com.brgd.brblmesh.GeneralClass.ble.bleTool.Request$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
    ...
    final class RequestCallback implements SuccessCallback, FailCallback, InvalidRequestCallback {
        ...
        @Override // com.brgd.brblmesh.GeneralClass.ble.bleTool.callback.InvalidRequestCallback
