...
public class JSONPath implements JSONAware {
    ...
    public boolean remove(Object obj) {
        ...
        if (segment instanceof PropertySegment) {
            ...
            if ((objEval instanceof Collection) && segmentArr2.length > 1) {
                ...
                if ((segment2 instanceof RangeSegment) || (segment2 instanceof MultiIndexSegment)) {
                    Iterator it = ((Collection) objEval).iterator();
                    while (it.hasNext()) {
            ...
            return propertySegment.remove(this, objEval);
        }
        if (segment instanceof ArrayAccessSegment) {
    ...
    */
    ...
    static class JSONPathParser {
        ...
        /* JADX WARN: Removed duplicated region for block: B:290:0x03d6 A[LOOP:9: B:288:0x03d2->B:290:0x03d6, LOOP_END] */
        /* JADX WARN: Removed duplicated region for block: B:293:0x03de  */
        /* JADX WARN: Removed duplicated region for block: B:295:0x03e4  */
        /* JADX WARN: Removed duplicated region for block: B:297:0x03e9  */
        /* JADX WARN: Removed duplicated region for block: B:43:0x0082  */
        /* JADX WARN: Removed duplicated region for block: B:481:0x03da A[EDGE_INSN: B:481:0x03da->B:291:0x03da BREAK  A[LOOP:9: B:288:0x03d2->B:290:0x03d6], SYNTHETIC] */
        /* JADX WARN: Removed duplicated region for block: B:56:0x00c0  */
        /*
            Code decompiled incorrectly, please refer to instructions dump.
            To view partially-correct code enable 'Show inconsistent code' option in preferences
        */
        java.lang.Object parseArrayAccessFilter(boolean r23) {
            /*
        ...
        protected Object readValue() {
            ...
            if (c == 'n') {
                if (GlobalVariable.nullColor.equals(readName())) {
                    return null;
                }
        ...
        Segment buildArraySegement(String str) {
            ...
            if (str.length() > 2 && cCharAt == '\'' && cCharAt2 == '\'') {
                ...
                String[] strArrSplit = str.split(EListUtils.DEFAULT_JOIN_SEPARATOR);
            ...
            if (iIndexOf != -1) {
                String[] strArrSplit2 = str.split(EListUtils.DEFAULT_JOIN_SEPARATOR);
