    ...
    public final void parkedWorkersStackTopUpdate(Worker worker, int oldIndex, int newIndex) {
        ...
        while (true) {
            ...
            if (iParkedWorkersStackNextIndex >= 0) {
                if (parkedWorkersStack$FU.compareAndSet(this, j, j2 | ((long) iParkedWorkersStackNextIndex))) {
                    return;
                }
            }
        }
    ...
    */
    public final void shutdown(long r8) {
        ...
        Lb:
            ...
            monitor-enter(r1)
            java.util.concurrent.atomic.AtomicLongFieldUpdater r3 = access$getControlState$FU$p()     // Catch: java.lang.Throwable -> Lbe
            long r3 = r3.get(r7)     // Catch: java.lang.Throwable -> Lbe
