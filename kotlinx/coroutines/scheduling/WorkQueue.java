...
public final class WorkQueue {
    ...
    private final Task tryExtractFromTheMiddle(int index, boolean onlyBlocking) {
        ...
        if (task != null) {
            if ((task.taskContext.getTaskMode() == 1) == onlyBlocking && AtomicIntrinsicsKt$$ExternalSyntheticBackportWithForwarding0.m(this.buffer, i, task, null)) {
                if (onlyBlocking) {
