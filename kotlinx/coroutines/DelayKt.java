...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo2960scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m2891delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m2892toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2892toDelayMillisLRDsOJo(long j) {
        if (Duration.m2749compareToLRDsOJo(j, Duration.INSTANCE.m2841getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m2761getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
