...
public final class LimitedDispatcher extends CoroutineDispatcher implements Delay {
    ...
    public void mo2960scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        this.$$delegate_0.mo2960scheduleResumeAfterDelay(timeMillis, continuation);
    }
        ...
        public void run() {
            ...
            while (true) {
                ...
                if (i >= 16 && LimitedDispatcher.this.dispatcher.isDispatchNeeded(LimitedDispatcher.this)) {
                    LimitedDispatcher.this.dispatcher.mo2959dispatch(LimitedDispatcher.this, this);
                    return;
                }
            }
        }
    ...
    public void mo2959dispatch(CoroutineContext context, Runnable block) {
        ...
        this.dispatcher.mo2959dispatch(this, new Worker(runnableObtainTaskOrDeallocateWorker));
    }
