...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        Object objM1359constructorimpl;
        if (e instanceof CopyableThrowable) {
            try {
                Result.Companion companion = Result.INSTANCE;
                objM1359constructorimpl = Result.m1359constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM1359constructorimpl = Result.m1359constructorimpl(ResultKt.createFailure(th));
            }
            if (Result.m1365isFailureimpl(objM1359constructorimpl)) {
                objM1359constructorimpl = null;
            }
            return (E) objM1359constructorimpl;
        }
        ...
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt.safeCtor.1
            ...
            public final Throwable invoke(Throwable th) {
                ...
                try {
                    ...
                    objM1359constructorimpl = Result.m1359constructorimpl(thInvoke);
                } catch (Throwable th2) {
                    Result.Companion companion2 = Result.INSTANCE;
                    objM1359constructorimpl = Result.m1359constructorimpl(ResultKt.createFailure(th2));
                }
                return (Throwable) (Result.m1365isFailureimpl(objM1359constructorimpl) ? null : objM1359constructorimpl);
            }
        };
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM1359constructorimpl = Result.m1359constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM1359constructorimpl = Result.m1359constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m1365isFailureimpl(objM1359constructorimpl)) {
            objM1359constructorimpl = numValueOf;
        }
        return ((Number) objM1359constructorimpl).intValue();
    }
