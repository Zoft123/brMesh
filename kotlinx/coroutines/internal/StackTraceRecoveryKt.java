...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM1359constructorimpl2;
        ...
        try {
            ...
            objM1359constructorimpl = Result.m1359constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM1359constructorimpl = Result.m1359constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m1362exceptionOrNullimpl(objM1359constructorimpl) == null) {
            obj2 = objM1359constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM1359constructorimpl2 = Result.m1359constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM1359constructorimpl2 = Result.m1359constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m1362exceptionOrNullimpl(objM1359constructorimpl2) == null) {
            obj = objM1359constructorimpl2;
        }
