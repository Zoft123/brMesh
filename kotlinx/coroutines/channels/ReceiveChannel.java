...
public interface ReceiveChannel<E> {
    ...
    Object mo2907receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo2908tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo2908tryReceivePtdJZtk = receiveChannel.mo2908tryReceivePtdJZtk();
            if (ChannelResult.m2923isSuccessimpl(objMo2908tryReceivePtdJZtk)) {
                return (E) ChannelResult.m2919getOrThrowimpl(objMo2908tryReceivePtdJZtk);
            }
            Throwable thM2917exceptionOrNullimpl = ChannelResult.m2917exceptionOrNullimpl(objMo2908tryReceivePtdJZtk);
            if (thM2917exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM2917exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r4, kotlin.coroutines.Continuation<? super E> r5) throws java.lang.Throwable {
            ...
            L38:
                kotlin.ResultKt.throwOnFailure(r5)
                r0.label = r3
                java.lang.Object r4 = r4.mo2907receiveCatchingJP2dKIU(r0)
                if (r4 != r1) goto L44
                return r1
            L44:
                java.lang.Object r4 = kotlinx.coroutines.channels.ChannelResult.m2918getOrNullimpl(r4)
                return r4
            */
