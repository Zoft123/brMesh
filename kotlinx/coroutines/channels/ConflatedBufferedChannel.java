...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object objM2931trySendImplMj0NB7M = conflatedBufferedChannel.m2931trySendImplMj0NB7M(e, true);
        if (objM2931trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m2917exceptionOrNullimpl(objM2931trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object objM2931trySendImplMj0NB7M = conflatedBufferedChannel.m2931trySendImplMj0NB7M(e, true);
        if (!(objM2931trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo2903trySendJP2dKIU(E element) {
        return m2931trySendImplMj0NB7M(element, false);
    }

    /* JADX INFO: renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m2931trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m2929trySendDropLatestMj0NB7M(element, isSendOp) : m2930trySendDropOldestJP2dKIU(element);
    }

    /* JADX INFO: renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m2929trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException$default;
        Object objMo2903trySendJP2dKIU = super.mo2903trySendJP2dKIU(element);
        if (ChannelResult.m2923isSuccessimpl(objMo2903trySendJP2dKIU) || ChannelResult.m2921isClosedimpl(objMo2903trySendJP2dKIU)) {
            return objMo2903trySendJP2dKIU;
        }
    ...
    private final Object m2930trySendDropOldestJP2dKIU(E element) {
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object objMo2903trySendJP2dKIU = mo2903trySendJP2dKIU(element);
        if (!(objMo2903trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(objMo2903trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m2917exceptionOrNullimpl(objMo2903trySendJP2dKIU);
