...
public interface SendChannel<E> {
    ...
    Object mo2903trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m2923isSuccessimpl(objMo2903trySendJP2dKIU)) {
                return true;
            }
            Throwable thM2917exceptionOrNullimpl = ChannelResult.m2917exceptionOrNullimpl(objMo2903trySendJP2dKIU);
