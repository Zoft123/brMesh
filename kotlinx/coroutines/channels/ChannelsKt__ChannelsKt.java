...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            try {
                ...
                objM1359constructorimpl = Result.m1359constructorimpl(Unit.INSTANCE);
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM1359constructorimpl = Result.m1359constructorimpl(ResultKt.createFailure(th));
            }
            return ChannelResult.m2913boximpl(Result.m1366isSuccessimpl(objM1359constructorimpl) ? ChannelResult.INSTANCE.m2928successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m2926closedJP2dKIU(Result.m1362exceptionOrNullimpl(objM1359constructorimpl)));
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object objMo2903trySendJP2dKIU = sendChannel.mo2903trySendJP2dKIU(e);
    ...
    public static final /* synthetic */ void sendBlocking(SendChannel sendChannel, Object obj) throws InterruptedException {
        if (ChannelResult.m2923isSuccessimpl(sendChannel.mo2903trySendJP2dKIU(obj))) {
            return;
        }
