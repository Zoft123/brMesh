...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo2907receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo2907receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo2908tryReceivePtdJZtk() {
        return this._channel.mo2908tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* JADX INFO: renamed from: trySend-JP2dKIU */
    public Object mo2903trySendJP2dKIU(E element) {
        return this._channel.mo2903trySendJP2dKIU(element);
    }
