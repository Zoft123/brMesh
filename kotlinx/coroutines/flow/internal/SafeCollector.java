...
public final class SafeCollector<T> extends ContinuationImpl implements FlowCollector<T>, CoroutineStackFrame {
    ...
    public Object invokeSuspend(Object result) {
        Throwable thM1362exceptionOrNullimpl = Result.m1362exceptionOrNullimpl(result);
        if (thM1362exceptionOrNullimpl != null) {
            this.lastEmissionContext = new DownstreamExceptionContext(thM1362exceptionOrNullimpl, getContext());
        }
        Continuation<? super Unit> continuation = this.completion;
