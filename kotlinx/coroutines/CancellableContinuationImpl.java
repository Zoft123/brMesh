...
public class CancellableContinuationImpl<T> extends DispatchedTask<T> implements CancellableContinuation<T>, CoroutineStackFrame, Waiter {
    ...
    public void cancelCompletedResult$kotlinx_coroutines_core(Object takenState, Throwable cause) {
        ...
        while (true) {
            ...
            if (obj instanceof CompletedContinuation) {
                ...
                Throwable th2 = cause;
                th = th2;
                if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, obj, CompletedContinuation.copy$default(completedContinuation, null, null, null, null, th2, 15, null))) {
                    completedContinuation.invokeHandlers(this, th);
                    return;
                }
            } else {
                th = cause;
                if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, obj, new CompletedContinuation(obj, null, null, null, th, 14, null))) {
                    return;
                }
            }
            cause = th;
    ...
    private final boolean tryResume() {
        ...
        } while (!_decisionAndIndex$FU.compareAndSet(this, i, BasicMeasure.EXACTLY + (536870911 & i)));
        return true;
    }
    ...
    private final void resumeImpl(Object proposedUpdate, int resumeMode, Function1<? super Throwable, Unit> onCancellation) {
        ...
        while (true) {
            ...
            if (obj instanceof NotCompleted) {
                ...
                if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, obj, resumedState((NotCompleted) obj, obj2, i, function1, null))) {
                    detachChildIfNonResuable();
                    dispatchResume(i);
                    return;
                } else {
    ...
    private final Symbol tryResumeImpl(Object proposedUpdate, Object idempotent, Function1<? super Throwable, Unit> onCancellation) {
        ...
        while (true) {
            ...
            if (obj instanceof NotCompleted) {
                ...
                Function1<? super Throwable, Unit> function1 = onCancellation;
                if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, obj, resumedState((NotCompleted) obj, obj2, this.resumeMode, function1, obj3))) {
                    detachChildIfNonResuable();
