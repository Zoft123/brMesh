...
final class ContinuationHandler<T> implements BiFunction<T, Throwable, Unit> {
    ...
    public void apply2(T result, Throwable exception) {
        ...
        if (exception == null) {
            ...
            continuation.resumeWith(Result.m1359constructorimpl(result));
            return;
        }
        CompletionException completionExceptionM2603m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m$1(exception) ? PathTreeWalk$$ExternalSyntheticApiModelOutline0.m2603m((Object) exception) : null;
        if (completionExceptionM2603m != null && (cause = completionExceptionM2603m.getCause()) != null) {
            exception = cause;
        }
        Result.Companion companion2 = Result.INSTANCE;
        continuation.resumeWith(Result.m1359constructorimpl(ResultKt.createFailure(exception)));
    }
}
