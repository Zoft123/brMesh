...
public final class FutureKt {
    ...
    public static final <T> CompletableFuture<T> future(CoroutineScope coroutineScope, CoroutineContext coroutineContext, CoroutineStart coroutineStart, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2) {
        ...
        CompletableFuture<T> completableFutureM3157m = NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m3157m();
        CompletableFutureCoroutine completableFutureCoroutine = new CompletableFutureCoroutine(coroutineContextNewCoroutineContext, completableFutureM3157m);
        completableFutureM3157m.handle((BiFunction) completableFutureCoroutine);
        completableFutureCoroutine.start(coroutineStart, completableFutureCoroutine, function2);
        return completableFutureM3157m;
    }

    public static final <T> CompletableFuture<T> asCompletableFuture(final Deferred<? extends T> deferred) {
        final CompletableFuture<T> completableFutureM3157m = NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m3157m();
        setupCancellation(deferred, completableFutureM3157m);
        deferred.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: kotlinx.coroutines.future.FutureKt.asCompletableFuture.1
            ...
            public final void invoke2(Throwable th) {
                try {
                    completableFutureM3157m.complete(deferred.getCompleted());
                } catch (Throwable th2) {
                    completableFutureM3157m.completeExceptionally(th2);
                }
            }
        });
        return completableFutureM3157m;
    ...
    public static final CompletableFuture<Unit> asCompletableFuture(Job job) {
        final CompletableFuture<Unit> completableFutureM3157m = NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m3157m();
        setupCancellation(job, completableFutureM3157m);
        job.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: kotlinx.coroutines.future.FutureKt.asCompletableFuture.2
            ...
            public final void invoke2(Throwable th) {
                if (th == null) {
                    completableFutureM3157m.complete(Unit.INSTANCE);
                } else {
                    completableFutureM3157m.completeExceptionally(th);
                }
            }
        });
        return completableFutureM3157m;
            ...
            public final Object invoke(T t, Throwable th2) {
                ...
                try {
                    if (th2 == null) {
                        ...
                        CompletionException completionExceptionM2603m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m$1(th2) ? PathTreeWalk$$ExternalSyntheticApiModelOutline0.m2603m((Object) th2) : null;
                        if (completionExceptionM2603m != null && (cause2 = completionExceptionM2603m.getCause()) != null) {
                            th2 = cause2;
                        }
