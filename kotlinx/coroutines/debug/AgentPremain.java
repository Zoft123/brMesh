...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM1359constructorimpl = Result.m1359constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM1359constructorimpl = Result.m1359constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m1365isFailureimpl(objM1359constructorimpl) ? null : objM1359constructorimpl);
