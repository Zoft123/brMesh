...
public final class BLSpanUtils {
    ...
    public BLSpanUtils setFlag(int i) {
        this.flag = i;
        return this;
    }

    public BLSpanUtils setForegroundColor(int i) {
        this.foregroundColor = i;
        return this;
    }

    public BLSpanUtils setBackgroundColor(int i) {
        this.backgroundColor = i;
        return this;
    }

    public BLSpanUtils setLineHeight(int i) {
        return setLineHeight(i, 2);
    }

    public BLSpanUtils setLineHeight(int i, int i2) {
        this.lineHeight = i;
        this.alignLine = i2;
        return this;
    }

    public BLSpanUtils setQuoteColor(int i) {
        return setQuoteColor(i, 2, 2);
    }

    public BLSpanUtils setQuoteColor(int i, int i2, int i3) {
        this.quoteColor = i;
        this.stripeWidth = i2;
    ...
    public BLSpanUtils setLeadingMargin(int i, int i2) {
        this.first = i;
        this.rest = i2;
        return this;
    }

    public BLSpanUtils setBullet(int i) {
        return setBullet(0, 3, i);
    }

    public BLSpanUtils setBullet(int i, int i2, int i3) {
        this.bulletColor = i;
    ...
    public BLSpanUtils setFontSize(int i) {
        return setFontSize(i, false);
    }

    public BLSpanUtils setFontSize(int i, boolean z) {
        this.fontSize = i;
        this.fontSizeIsDp = z;
        return this;
    }

    public BLSpanUtils setFontProportion(float f) {
        this.proportion = f;
        return this;
    }

    public BLSpanUtils setFontXProportion(float f) {
        this.xProportion = f;
        return this;
    }

    public BLSpanUtils setStrikethrough() {
        this.isStrikethrough = true;
        return this;
    }

    public BLSpanUtils setUnderline() {
        this.isUnderline = true;
        return this;
    }

    public BLSpanUtils setSuperscript() {
        this.isSuperscript = true;
        return this;
    }

    public BLSpanUtils setSubscript() {
        this.isSubscript = true;
        return this;
    }

    public BLSpanUtils setBold() {
        this.isBold = true;
        return this;
    }

    public BLSpanUtils setItalic() {
        this.isItalic = true;
        return this;
    }

    public BLSpanUtils setBoldItalic() {
        this.isBoldItalic = true;
        return this;
    }

    public BLSpanUtils setFontFamily(String str) {
        this.fontFamily = str;
        return this;
    }

    public BLSpanUtils setTypeface(Typeface typeface) {
        this.typeface = typeface;
        return this;
    }

    public BLSpanUtils setAlign(Layout.Alignment alignment) {
        this.alignment = alignment;
        return this;
    }

    public BLSpanUtils setClickSpan(ClickableSpan clickableSpan) {
        this.clickSpan = clickableSpan;
        return this;
    }

    public BLSpanUtils setUrl(String str) {
        this.url = str;
        return this;
    }

    public BLSpanUtils setBlur(float f, BlurMaskFilter.Blur blur) {
        this.blurRadius = f;
        this.style = blur;
        return this;
    }

    public BLSpanUtils setShader(Shader shader) {
        this.shader = shader;
        return this;
    }

    public BLSpanUtils setShadow(float f, float f2, float f3, int i) {
        this.shadowRadius = f;
        this.shadowDx = f2;
        this.shadowDy = f3;
        this.shadowColor = i;
    ...
    public BLSpanUtils setSpans(Object... objArr) {
        if (objArr.length > 0) {
            this.spans = objArr;
        }
        return this;
    ...
    public BLSpanUtils append(CharSequence charSequence) {
        apply(0);
        this.mText = charSequence;
        return this;
    }

    public BLSpanUtils appendLine() {
        apply(0);
        this.mText = LINE_SEPARATOR;
        return this;
    }

    public BLSpanUtils appendLine(CharSequence charSequence) {
        apply(0);
        this.mText = ((Object) charSequence) + LINE_SEPARATOR;
        return this;
    }

    public BLSpanUtils appendImage(Bitmap bitmap) {
        return appendImage(bitmap, 0);
    }

    public BLSpanUtils appendImage(Bitmap bitmap, int i) {
        apply(1);
    ...
    public BLSpanUtils appendImage(Drawable drawable) {
        return appendImage(drawable, 0);
    }

    public BLSpanUtils appendImage(Drawable drawable, int i) {
        apply(1);
    ...
    public BLSpanUtils appendImage(Uri uri) {
        return appendImage(uri, 0);
    }

    public BLSpanUtils appendImage(Uri uri, int i) {
        apply(1);
        this.imageUri = uri;
        this.alignImage = i;
        return this;
    ...
    public BLSpanUtils appendImage(int i) {
        return appendImage(i, 0);
    }

    public BLSpanUtils appendImage(int i, int i2) {
    ...
    public BLSpanUtils appendSpace(int i) {
        return appendSpace(i, 0);
    }

    public BLSpanUtils appendSpace(int i, int i2) {
        apply(2);
        this.spaceSize = i;
        this.spaceColor = i2;
        return this;
    ...
    class SpaceSpan extends ReplacementSpan {
        ...
        private SpaceSpan(BLSpanUtils bLSpanUtils, int i) {
            this(i, 0);
        }
    ...
    class CustomQuoteSpan implements LeadingMarginSpan {
        ...
        public void drawLeadingMargin(Canvas canvas, Paint paint, int i, int i2, int i3, int i4, int i5, CharSequence charSequence, int i6, int i7, boolean z, Layout layout) {
            ...
            paint.setStyle(Paint.Style.FILL);
            paint.setColor(this.color);
            canvas.drawRect(i, i3, i + (i2 * this.stripeWidth), i5, paint);
            paint.setStyle(style);
            paint.setColor(color);
        }
    }
    ...
    class CustomImageSpan extends CustomDynamicDrawableSpan {
        ...
        private CustomImageSpan(Bitmap bitmap, int i) {
            super(i);
            BitmapDrawable bitmapDrawable = new BitmapDrawable(EAppUtils.getApp().getResources(), bitmap);
        ...
        @Override // cn.com.broadlink.blelight.util.BLSpanUtils.CustomDynamicDrawableSpan
        public Drawable getDrawable() {
            ...
            if (this.mContentUri != null) {
                try {
                    InputStream inputStreamOpenInputStream = EAppUtils.getApp().getContentResolver().openInputStream(this.mContentUri);
                    BitmapDrawable bitmapDrawable = new BitmapDrawable(EAppUtils.getApp().getResources(), BitmapFactory.decodeStream(inputStreamOpenInputStream));
                    try {
                ...
                try {
                    drawable2 = ContextCompat.getDrawable(EAppUtils.getApp(), this.mResourceId);
