...
public final class UStringsKt {
    ...
    public static final String m2737toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m2739toStringolVBNx4(short s, int i) {
    ...
    public static final String m2738toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m2736toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m1456constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m1371boximpl(UByte.m1377constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m1456constructorimpl(65535) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m1636boximpl(UShort.m1642constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM1456constructorimpl = UInt.m1456constructorimpl(i);
        int iM = 119304647;
        while (i2 < length) {
            ...
            if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM ^ Integer.MIN_VALUE) > 0) {
                if (iM == 119304647) {
                    iM = UByte$$ExternalSyntheticBackport0.m(-1, iM1456constructorimpl);
                    if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM ^ Integer.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            int iM1456constructorimpl2 = UInt.m1456constructorimpl(i3 * iM1456constructorimpl);
            int iM1456constructorimpl3 = UInt.m1456constructorimpl(UInt.m1456constructorimpl(iDigitOf) + iM1456constructorimpl2);
            if (Integer.compare(iM1456constructorimpl3 ^ Integer.MIN_VALUE, iM1456constructorimpl2 ^ Integer.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            i3 = iM1456constructorimpl3;
        }
        return UInt.m1450boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM1535constructorimpl = ULong.m1535constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                if (jM$1 == 512409557603043100L) {
                    jM$1 = UByte$$ExternalSyntheticBackport0.m$1(-1L, jM1535constructorimpl);
                    if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            long jM1535constructorimpl2 = ULong.m1535constructorimpl(j * jM1535constructorimpl);
            long jM1535constructorimpl3 = ULong.m1535constructorimpl(ULong.m1535constructorimpl(((long) UInt.m1456constructorimpl(iDigitOf)) & 4294967295L) + jM1535constructorimpl2);
            if (Long.compare(jM1535constructorimpl3 ^ Long.MIN_VALUE, jM1535constructorimpl2 ^ Long.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            j = jM1535constructorimpl3;
        }
        return ULong.m1529boximpl(j);
    }
}
