...
public final class HexExtensionsKt {
    ...
    private static final int checkFormatLength(long j) {
        ...
        throw new IllegalArgumentException("The resulting string length is too big: " + ((Object) ULong.m1581toStringimpl(ULong.m1535constructorimpl(j))));
    }
    ...
    */
    ...
    public static final String toHexString(byte b, HexFormat format) {
        ...
        if (number.getIsDigitsOnlyAndNoPadding()) {
            char[] cArr = {str.charAt((b >> 4) & 15), str.charAt(b & BSON.CODE_W_SCOPE)};
