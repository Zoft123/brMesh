...
public final class Uuid implements Comparable<Uuid>, Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m1529boximpl(ULong.m1535constructorimpl(getMostSignificantBits())), ULong.m1529boximpl(ULong.m1535constructorimpl(getLeastSignificantBits())));
    }
    ...
    public final byte[] m2887toUByteArrayTcUX1vc() {
        return UByteArray.m1432constructorimpl(toByteArray());
    }
    ...
    public int compareTo(Uuid other) {
        ...
        return j != other.mostSignificantBits ? Long.compare(ULong.m1535constructorimpl(j) ^ Long.MIN_VALUE, ULong.m1535constructorimpl(other.mostSignificantBits) ^ Long.MIN_VALUE) : Long.compare(ULong.m1535constructorimpl(this.leastSignificantBits) ^ Long.MIN_VALUE, ULong.m1535constructorimpl(other.leastSignificantBits) ^ Long.MIN_VALUE);
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m2889fromULongseb3DHEI(long mostSignificantBits, long leastSignificantBits) {
        ...
        public final Uuid m2888fromUByteArrayGBYM_sE(byte[] ubyteArray) {
