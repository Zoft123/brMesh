    ...
    public static <E extends RealmModel> E freeze(E e) {
        if (e instanceof RealmObjectProxy) {
            ...
            if (baseRealmFreeze instanceof Realm) {
                ...
                return (E) baseRealmFreeze.getConfiguration().getSchemaMediator().newInstance(superclass, baseRealmFreeze, rowFreeze, realm$realm.getSchema().getColumnInfo((Class<? extends RealmModel>) superclass), false, Collections.EMPTY_LIST);
            }
            throw new UnsupportedOperationException("Unknown Realm type: " + baseRealmFreeze.getClass().getName());
        }
