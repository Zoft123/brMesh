...
/* JADX INFO: compiled from: RealmFieldType.java */
...
interface RealmFieldTypeConstants {
    ...
    public static final int CORE_TYPE_VALUE_DECIMAL128 = 11;
    ...
    public static final int CORE_TYPE_VALUE_MIXED = 6;
    public static final int CORE_TYPE_VALUE_OBJECT = 12;
    public static final int CORE_TYPE_VALUE_OBJECTID = 15;
    public static final int CORE_TYPE_VALUE_STRING = 2;
    public static final int CORE_TYPE_VALUE_TYPED_LINK = 16;
    public static final int CORE_TYPE_VALUE_UUID = 17;
    public static final int DICTIONARY_OFFSET = 512;
    public static final int LIST_OFFSET = 128;
    public static final int MAX_CORE_TYPE_VALUE = 17;
    public static final int SET_OFFSET = 256;
}
