...
public class Realm extends BaseRealm {
    ...
    private static void initializeRealm(Context context, String str) {
        if (BaseRealm.applicationContext == null) {
            ...
            ObjectServerFacade.getSyncFacadeIfPossible().initialize(context, str, new ObjectServerFacade.RealmCacheAccessor() { // from class: io.realm.Realm$$ExternalSyntheticLambda1
            ...
            }, new ObjectServerFacade.RealmInstanceFactory() { // from class: io.realm.Realm$$ExternalSyntheticLambda2
    ...
    static /* synthetic */ Realm lambda$initializeRealm$0(RealmConfiguration realmConfiguration, OsSharedRealm.VersionID versionID) {
    ...
    public <E extends RealmModel> E createObjectFromJson(Class<E> cls, InputStream inputStream) throws IOException {
        ...
        try {
            if (OsObjectStore.getPrimaryKeyForObject(this.sharedRealm, this.configuration.getSchemaMediator().getSimpleClassName(cls)) != null) {
                try {
                    fullStringScanner = getFullStringScanner(inputStream);
                    return (E) this.configuration.getSchemaMediator().createOrUpdateUsingJsonObject(cls, this, new JSONObject(fullStringScanner.next()), false);
                } catch (JSONException e) {
                    throw new RealmException("Failed to read JSON", e);
                }
            }
    ...
    public <E extends RealmModel> E createObject(Class<E> cls) {
        ...
        return (E) createObjectInternal(cls, true, Collections.EMPTY_LIST);
    }
    ...
    public <E extends RealmModel> E createObject(Class<E> cls, @Nullable Object obj) {
        ...
        return (E) createObjectInternal(cls, obj, true, Collections.EMPTY_LIST);
    }
    ...
    public RealmAsyncTask executeTransactionAsync(Transaction transaction, @Nullable Transaction.OnSuccess onSuccess, @Nullable Transaction.OnError onError) {
        ...
        return new RealmAsyncTaskImpl(asyncTaskExecutor.submitTransaction(new AnonymousClass1(getConfiguration(), transaction, zCanDeliverNotification, onSuccess, this.sharedRealm.realmNotifier, onError)), asyncTaskExecutor);
    }
    ...
    boolean hasPrimaryKey(Class<? extends RealmModel> cls) {
