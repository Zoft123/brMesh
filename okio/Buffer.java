...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public final byte m3132deprecated_getByte(long index) {
    ...
    */
        ...
        while (beginIndex < endIndex) {
            ...
            if (cCharAt2 < 128) {
                ...
                if (cCharAt2 < 2048) {
                    ...
                    segmentWritableSegment$okio2.data[segmentWritableSegment$okio2.limit] = (byte) ((cCharAt2 >> 6) | Opcodes.CHECKCAST);
    ...
    public Buffer writeUtf8CodePoint(int codePoint) {
        ...
        if (codePoint < 2048) {
            ...
            segmentWritableSegment$okio.data[segmentWritableSegment$okio.limit] = (byte) ((codePoint >> 6) | Opcodes.CHECKCAST);
    ...
    public Buffer writeDecimalLong(long v) {
        ...
        if (v != 0) {
            ...
            int iCountDigitsIn = okio.internal.Buffer.countDigitsIn(v);
            if (z) {
                iCountDigitsIn++;
            }
