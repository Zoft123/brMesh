...
public final class YearMonth implements Temporal, TemporalAdjuster, Comparable, Serializable {
    ...
    public YearMonth plusMonths(long j) {
        ...
        return with(ChronoField.YEAR.checkValidIntValue(DesugarLocalDate$$ExternalSyntheticBackport0.m(j2, 12)), DesugarLocalTime$$ExternalSyntheticBackport0.m(j2, 12) + 1);
    }
