...
public final class LocalDate implements Temporal, TemporalAdjuster, ChronoLocalDate, Serializable {
    ...
    public static LocalDate ofInstant(Instant instant, ZoneId zoneId) {
        ...
        return ofEpochDay(DesugarLocalDate$$ExternalSyntheticBackport0.m(instant.getEpochSecond() + ((long) zoneId.getRules().getOffset(instant).getTotalSeconds()), 86400));
    }
    ...
    public static LocalDate parse(CharSequence charSequence, DateTimeFormatter dateTimeFormatter) {
        ...
        return (LocalDate) dateTimeFormatter.parse(charSequence, new TemporalQuery() { // from class: j$.time.LocalDate$$ExternalSyntheticLambda1
    ...
    /* JADX INFO: renamed from: j$.time.LocalDate$1, reason: invalid class name */
    ...
    public LocalDate plusMonths(long j) {
        ...
        return resolvePreviousValid(ChronoField.YEAR.checkValidIntValue(DesugarLocalDate$$ExternalSyntheticBackport0.m(j2, 12)), DesugarLocalTime$$ExternalSyntheticBackport0.m(j2, 12) + 1, this.day);
    }
