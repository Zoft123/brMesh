...
public final class ZoneOffsetTransitionRule implements Serializable {
    ...
    static ZoneOffsetTransitionRule readExternal(DataInput dataInput) throws IOException {
        ...
        ZoneOffset zoneOffsetOfTotalSeconds = ZoneOffset.ofTotalSeconds(i5 == 255 ? dataInput.readInt() : (i5 - 128) * TypedValues.Custom.TYPE_INT);
    ...
    /* JADX INFO: renamed from: j$.time.zone.ZoneOffsetTransitionRule$1, reason: invalid class name */
