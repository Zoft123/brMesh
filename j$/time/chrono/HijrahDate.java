...
public final class HijrahDate extends ChronoLocalDateImpl implements ChronoLocalDate, Serializable {
    ...
    public HijrahDate plusMonths(long j) {
        ...
        return resolvePreviousValid(this.chrono.checkValidYear(DesugarLocalDate$$ExternalSyntheticBackport0.m(j2, 12L)), ((int) Clock$TickClock$$ExternalSyntheticBackport0.m(j2, 12L)) + 1, this.dayOfMonth);
    }
