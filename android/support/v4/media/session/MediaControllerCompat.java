...
public final class MediaControllerCompat {
    ...
    public MediaControllerCompat(Context context, MediaSessionCompat mediaSessionCompat) {
        MediaControllerImpl mediaControllerImplApi23;
        ...
        try {
            if (Build.VERSION.SDK_INT >= 24) {
                mediaControllerImplApi23 = new MediaControllerImplApi24(context, sessionToken);
            } else {
                mediaControllerImplApi23 = new MediaControllerImplApi23(context, sessionToken);
            }
        } catch (RemoteException e) {
