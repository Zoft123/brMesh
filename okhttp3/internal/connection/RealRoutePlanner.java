...
public final class RealRoutePlanner implements RoutePlanner {
    ...
    public final ReusePlan planReusePooledConnection$okhttp(ConnectPlan planToReplace, List<Route> routes) {
        RealConnection realConnectionCallAcquirePooledConnection = this.connectionPool.callAcquirePooledConnection(this.connectionUser.doExtensiveHealthChecks(), getAddress(), this.connectionUser, routes, planToReplace != null && planToReplace.getIsReady());
