            ...
            if (z && (iCodePointAt == 9 || iCodePointAt == 10 || iCodePointAt == 12 || iCodePointAt == 13)) {
                ...
                if (iCodePointAt == 32 && encodeSet == FORM_ENCODE_SET) {
                    ...
                    while (!buffer2.exhausted()) {
                        ...
                        buffer.writeByte((int) cArr[b & BSON.CODE_W_SCOPE]);
                    }
