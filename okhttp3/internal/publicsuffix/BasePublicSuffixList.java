    ...
    private final void readTheList() throws IOException {
        try {
            ...
            try {
                ...
                ByteString byteString = bufferedSource.readByteString(bufferedSource.readInt());
                ByteString byteString2 = bufferedSource.readByteString(bufferedSource.readInt());
