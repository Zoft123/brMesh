...
public class Platform {
    ...
    public List<String> getHandshakeServerNames(SSLSocket sslSocket) {
        ...
        ExtendedSSLSession extendedSSLSessionM3158m = NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m3161m((Object) session) ? NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m3158m((Object) session) : null;
        if (extendedSSLSessionM3158m == null) {
            return CollectionsKt.emptyList();
        }
        try {
            List requestedServerNames = extendedSSLSessionM3158m.getRequestedServerNames();
            ...
            while (it.hasNext()) {
                SNIServerName sNIServerNameM3160m = NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m3160m(it.next());
                SNIHostName sNIHostNameM3159m = NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m$1(sNIServerNameM3160m) ? NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m3159m((Object) sNIServerNameM3160m) : null;
                String asciiName = sNIHostNameM3159m != null ? sNIHostNameM3159m.getAsciiName() : null;
                if (asciiName != null) {
