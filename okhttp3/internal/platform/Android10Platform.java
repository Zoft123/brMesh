...
public final class Android10Platform extends Platform implements ContextAwarePlatform {
    ...
    public Object getStackTraceForCloseable(String closer) {
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            CloseGuard closeGuardM = NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m();
            closeGuardM.open(closer);
            return closeGuardM;
        }
    ...
    public void logCloseableLeak(String message, Object stackTrace) {
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m(stackTrace).warnIfOpen();
        } else {
    ...
    /* JADX INFO: compiled from: Android10Platform.kt */
    @Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\b\u0010\u0007\u001a\u0004\u0018\u00010\bR\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u0004\u0010\u0006¨\u0006\t"}, d2 = {"Lokhttp3/internal/platform/Android10Platform$Companion;", "", "<init>", "()V", "isSupported", "", "()Z", "buildIfSupported", "Lokhttp3/internal/platform/Platform;", "okhttp"}, k = 1, mv = {2, 2, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
