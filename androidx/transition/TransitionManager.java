...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo477clone = transition.mo477clone();
        transitionMo477clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo477clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo477clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo477clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo477clone = transition.mo477clone();
        sceneChangeSetup(viewGroup, transitionMo477clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo477clone);
    }
