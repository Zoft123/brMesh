        ...
        if (parentMatches(viewGroup2, viewGroup3)) {
            ...
            if (i > 0) {
                if (!this.mResizeClip) {
                    ...
                    ObjectAnimator objectAnimatorOfPointF3 = (i3 == i4 && i5 == i6) ? null : ObjectAnimatorUtils.ofPointF(view2, POSITION_PROPERTY, getPathMotion().getPath(i3, i5, i4, i6));
                    if (rect4 == null) {
                        i2 = 0;
                    ...
                    if (rect.equals(rect6)) {
                        ...
                        objArr[i2] = rect;
                        objArr[1] = rect6;
                        ObjectAnimator objectAnimatorOfObject = ObjectAnimator.ofObject(view2, "clipBounds", rectEvaluator, objArr);
                        view = view2;
