        ...
        private void createListView(AlertController alertController) {
            ...
            if (this.mIsMultiChoice) {
                ...
                if (alertParams.mCursor != null) {
                    checkedItemAdapter = new SimpleCursorAdapter(alertParams.mContext, i2, alertParams.mCursor, new String[]{alertParams.mLabelColumn}, new int[]{android.R.id.text1});
                } else {
                    checkedItemAdapter = alertParams.mAdapter;
                    if (checkedItemAdapter == null) {
                        checkedItemAdapter = new CheckedItemAdapter(alertParams.mContext, i2, android.R.id.text1, alertParams.mItems);
                    }
                }
            }
