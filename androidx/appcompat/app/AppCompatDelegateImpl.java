    ...
    */
    ...
    LocaleListCompat calculateApplicationLocales(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            localeListCompatForLanguageTags = LocaleOverlayHelper.combineLocalesIfOverlayExists(requestedAppLocales, configurationLocales);
        } else if (requestedAppLocales.isEmpty()) {
            localeListCompatForLanguageTags = LocaleListCompat.getEmptyLocaleList();
        } else {
            localeListCompatForLanguageTags = LocaleListCompat.forLanguageTags(requestedAppLocales.get(0).toString());
        }
        return localeListCompatForLanguageTags.isEmpty() ? configurationLocales : localeListCompatForLanguageTags;
    }
    ...
    */
    ...
    static class Api33Impl {
        ...
        static OnBackInvokedCallback registerOnBackPressedCallback(Object obj, final AppCompatDelegateImpl appCompatDelegateImpl) {
            ...
            ComponentDialog$$ExternalSyntheticApiModelOutline0.m14m(obj).registerOnBackInvokedCallback(DurationKt.NANOS_IN_MILLIS, onBackInvokedCallback);
            return onBackInvokedCallback;
        }

        static void unregisterOnBackInvokedCallback(Object obj, Object obj2) {
            ComponentDialog$$ExternalSyntheticApiModelOutline0.m14m(obj).unregisterOnBackInvokedCallback(ComponentDialog$$ExternalSyntheticApiModelOutline0.m13m(obj2));
        }
