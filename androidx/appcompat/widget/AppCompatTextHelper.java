    ...
    void loadFromAttributes(AttributeSet attributeSet, int i) {
        ...
        if (string != null) {
            if (Build.VERSION.SDK_INT >= 24) {
                ...
                Api17Impl.setTextLocale(this.mView, Api21Impl.forLanguageTag(string.split(EListUtils.DEFAULT_JOIN_SEPARATOR)[0]));
            }
        }
            ...
            if (!context.isRestricted()) {
                ...
                try {
                    Typeface font = tintTypedArray.getFont(i, this.mStyle, new ResourcesCompat.FontCallback() { // from class: androidx.appcompat.widget.AppCompatTextHelper.1
                        ...
                        public void m373xb24343b7(int i5) {
                        }

                        @Override // androidx.core.content.res.ResourcesCompat.FontCallback
                        /* JADX INFO: renamed from: onFontRetrieved */
                        public void m374x46c88379(Typeface typeface) {
                            int i5;
