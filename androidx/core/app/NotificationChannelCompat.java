...
public class NotificationChannelCompat {
    ...
    NotificationChannel getNotificationChannel() {
        ...
        ComponentDialog$$ExternalSyntheticApiModelOutline0.m31m$1();
        NotificationChannel notificationChannelM = ComponentDialog$$ExternalSyntheticApiModelOutline0.m(this.mId, this.mName, this.mImportance);
        notificationChannelM.setDescription(this.mDescription);
        notificationChannelM.setGroup(this.mGroupId);
        notificationChannelM.setShowBadge(this.mShowBadge);
        notificationChannelM.setSound(this.mSound, this.mAudioAttributes);
        notificationChannelM.enableLights(this.mLights);
        notificationChannelM.setLightColor(this.mLightColor);
        notificationChannelM.setVibrationPattern(this.mVibrationPattern);
        notificationChannelM.enableVibration(this.mVibrationEnabled);
        if (Build.VERSION.SDK_INT >= 30 && (str = this.mParentId) != null && (str2 = this.mConversationId) != null) {
            notificationChannelM.setConversationId(str, str2);
        }
