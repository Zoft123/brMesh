...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        public Builder(Context context, Notification notification) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && (parcelableArrayList = notification.extras.getParcelableArrayList(NotificationCompat.EXTRA_PEOPLE_LIST)) != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it2.hasNext()) {
                    addPerson(Person.fromAndroidPerson(NotificationCompat$$ExternalSyntheticApiModelOutline0.m350m(it2.next())));
                }
            }
    ...
    public static abstract class Style {
        ...
        private static Style constructCompatStyleByPlatformName(String str) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                if (str.equals(NotificationCompat$$ExternalSyntheticApiModelOutline0.m358m().getName())) {
                    return new MessagingStyle();
                }
                if (str.equals(NotificationCompat$$ExternalSyntheticApiModelOutline0.m$1().getName())) {
    ...
    public static class MessagingStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            CharSequence text;
            Notification.MessagingStyle messagingStyleM;
            setGroupConversation(isGroupConversation());
            if (Build.VERSION.SDK_INT >= 24) {
                if (Build.VERSION.SDK_INT >= 28) {
                    NotificationCompat$$ExternalSyntheticApiModelOutline0.m363m();
                    messagingStyleM = NotificationCompat$$ExternalSyntheticApiModelOutline0.m(this.mUser.toAndroidPerson());
                } else {
                    NotificationCompat$$ExternalSyntheticApiModelOutline0.m363m();
                    messagingStyleM = NotificationCompat$$ExternalSyntheticApiModelOutline0.m(this.mUser.getName());
                }
                Iterator<Message> it = this.mMessages.iterator();
                while (it.hasNext()) {
                    messagingStyleM.addMessage(it.next().toAndroidMessage());
                }
                if (Build.VERSION.SDK_INT >= 26) {
                    Iterator<Message> it2 = this.mHistoricMessages.iterator();
                    while (it2.hasNext()) {
                        messagingStyleM.addHistoricMessage(it2.next().toAndroidMessage());
                    }
                }
                if (this.mIsGroupConversation.booleanValue() || Build.VERSION.SDK_INT >= 28) {
                    messagingStyleM.setConversationTitle(this.mConversationTitle);
                }
                if (Build.VERSION.SDK_INT >= 28) {
                    messagingStyleM.setGroupConversation(this.mIsGroupConversation.booleanValue());
                }
                messagingStyleM.setBuilder(notificationBuilderWithBuilderAccessor.getBuilder());
                return;
            }
        ...
        public static final class Message {
                ...
                try {
                    if (bundle.containsKey(KEY_TEXT) && bundle.containsKey(KEY_TIMESTAMP)) {
                        if (bundle.containsKey(KEY_PERSON)) {
                            ...
                            personBuild = Person.fromAndroidPerson(NotificationCompat$$ExternalSyntheticApiModelOutline0.m350m((Object) bundle.getParcelable(KEY_NOTIFICATION_PERSON)));
                        } else {
            ...
            Notification.MessagingStyle.Message toAndroidMessage() {
                Notification.MessagingStyle.Message messageM;
                Person person = getPerson();
                if (Build.VERSION.SDK_INT >= 28) {
                    NotificationCompat$$ExternalSyntheticApiModelOutline0.m370m$1();
                    messageM = NotificationCompat$$ExternalSyntheticApiModelOutline0.m(getText(), getTimestamp(), person != null ? person.toAndroidPerson() : null);
                } else {
                    NotificationCompat$$ExternalSyntheticApiModelOutline0.m370m$1();
                    messageM = NotificationCompat$$ExternalSyntheticApiModelOutline0.m(getText(), getTimestamp(), person != null ? person.getName() : null);
                }
                if (getDataMimeType() != null) {
                    messageM.setData(getDataMimeType(), getDataUri());
                }
                return messageM;
            }
        }
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            if (Build.VERSION.SDK_INT >= 24) {
                notificationBuilderWithBuilderAccessor.getBuilder().setStyle(NotificationCompat$$ExternalSyntheticApiModelOutline0.m());
            }
        }
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            public WearableExtender m371clone() {
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* JADX INFO: renamed from: clone, reason: merged with bridge method [inline-methods] */
        public WearableExtender m372clone() {
            WearableExtender wearableExtender = new WearableExtender();
    ...
    static Action getActionCompatFromAction(Notification.Action action) {
        ...
        if (action.getIcon() == null && action.icon != 0) {
            return new Action(action.icon, action.title, action.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z2, i2, z3, zIsContextual, zIsAuthenticationRequired);
        }
        return new Action(action.getIcon() != null ? IconCompat.createFromIconOrNullIfZeroResId(action.getIcon()) : null, action.title, action.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z2, i2, z3, zIsContextual, zIsAuthenticationRequired);
    }
    ...
    public static List<Person> getPeople(Notification notification) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            if (parcelableArrayList != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it.hasNext()) {
                    arrayList.add(Person.fromAndroidPerson(NotificationCompat$$ExternalSyntheticApiModelOutline0.m350m(it.next())));
                }
            }
        } else {
