...
public class WindowInsetsCompat {
    ...
    private static class BuilderImpl29 extends BuilderImpl {
        ...
        BuilderImpl29() {
            this.mPlatBuilder = HalfKt$$ExternalSyntheticApiModelOutline0.m447m();
        }

        BuilderImpl29(WindowInsetsCompat windowInsetsCompat) {
            WindowInsets.Builder builderM447m;
            super(windowInsetsCompat);
            WindowInsets windowInsets = windowInsetsCompat.toWindowInsets();
            if (windowInsets != null) {
                builderM447m = HalfKt$$ExternalSyntheticApiModelOutline0.m448m(windowInsets);
            } else {
                builderM447m = HalfKt$$ExternalSyntheticApiModelOutline0.m447m();
            }
            this.mPlatBuilder = builderM447m;
        }
