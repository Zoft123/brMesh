            ...
            if (cls != null) {
                try {
                    ...
                    try {
                        ...
                        Log.e(TAG, "Failed to execute command with argument class ViewCommandArgument: " + (cls2 == null ? GlobalVariable.nullColor : cls2.getName()), e);
                    }
                } catch (Exception e2) {
                    e = e2;
                }
    ...
    public static final class TouchDelegateInfoCompat {
        ...
        public TouchDelegateInfoCompat(Map<Region, View> map) {
            if (Build.VERSION.SDK_INT >= 29) {
                this.mInfo = Realm$$ExternalSyntheticApiModelOutline0.m((Map) map);
            } else {
                this.mInfo = null;
            }
        }
