...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    */
    ...
    public void getViewVelocity(View view, float posOnViewX, float posOnViewY, float[] returnVelocity, int type) {
        ...
        if ((type & 1) == 0) {
            fArr = returnVelocity;
            motionController.getPostLayoutDvDp(interpolation, view.getWidth(), view.getHeight(), posOnViewX, posOnViewY, fArr);
        } else {
            fArr = returnVelocity;
            motionController.getDpDt(interpolation, posOnViewX, posOnViewY, fArr);
        }
        if (type < 2) {
    ...
    class Model {
        ...
        private void debugLayoutParam(String str, ConstraintLayout.LayoutParams params) {
            String strConcat = " ".concat(params.startToStart != -1 ? "SS" : "__");
            ...
            sb2.append(string);
            sb2.append(params.endToStart != -1 ? "|ES" : "|__");
            String string2 = sb2.toString();
            StringBuilder sb3 = new StringBuilder();
            sb3.append(string2);
            sb3.append(params.endToEnd != -1 ? "|EE" : "|__");
            String string3 = sb3.toString();
            StringBuilder sb4 = new StringBuilder();
            sb4.append(string3);
            sb4.append(params.leftToLeft != -1 ? "|LL" : "|__");
            String string4 = sb4.toString();
            StringBuilder sb5 = new StringBuilder();
            sb5.append(string4);
            sb5.append(params.leftToRight != -1 ? "|LR" : "|__");
            String string5 = sb5.toString();
            StringBuilder sb6 = new StringBuilder();
            sb6.append(string5);
            sb6.append(params.rightToLeft != -1 ? "|RL" : "|__");
            String string6 = sb6.toString();
            StringBuilder sb7 = new StringBuilder();
            sb7.append(string6);
            sb7.append(params.rightToRight != -1 ? "|RR" : "|__");
            String string7 = sb7.toString();
            StringBuilder sb8 = new StringBuilder();
            sb8.append(string7);
            sb8.append(params.topToTop != -1 ? "|TT" : "|__");
            String string8 = sb8.toString();
            StringBuilder sb9 = new StringBuilder();
            sb9.append(string8);
            sb9.append(params.topToBottom != -1 ? "|TB" : "|__");
            String string9 = sb9.toString();
            StringBuilder sb10 = new StringBuilder();
            sb10.append(string9);
            sb10.append(params.bottomToTop != -1 ? "|BT" : "|__");
            String string10 = sb10.toString();
            StringBuilder sb11 = new StringBuilder();
            sb11.append(string10);
            sb11.append(params.bottomToBottom != -1 ? "|BB" : "|__");
            Log.v(MotionLayout.TAG, str + sb11.toString());
        }
        ...
        private void debugWidget(String str, ConstraintWidget child) {
            ...
            if (constraintAnchor != null) {
                strConcat = ExifInterface.GPS_DIRECTION_TRUE.concat(child.mTop.mTarget.mType == ConstraintAnchor.Type.TOP ? ExifInterface.GPS_DIRECTION_TRUE : "B");
            } else {
                strConcat = "__";
            }
            sb.append(strConcat);
            ...
            if (child.mLeft.mTarget != null) {
                strConcat3 = "L".concat(child.mLeft.mTarget.mType == ConstraintAnchor.Type.LEFT ? "L" : "R");
            } else {
                strConcat3 = "__";
            }
            ...
            if (child.mRight.mTarget != null) {
                strConcat4 = "R".concat(child.mRight.mTarget.mType != ConstraintAnchor.Type.LEFT ? "R" : "L");
            }
            sb4.append(strConcat4);
            Log.v(MotionLayout.TAG, str + sb4.toString() + " ---  " + child);
        }
        ...
        private void debugLayout(String title, ConstraintWidgetContainer c) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                StringBuilder sb2 = new StringBuilder();
                sb2.append(string);
                sb2.append(constraintWidget.mLeft.mTarget != null ? "L" : "_");
                String string2 = sb2.toString();
                StringBuilder sb3 = new StringBuilder();
                sb3.append(string2);
                sb3.append(constraintWidget.mRight.mTarget != null ? "R" : "_");
                String string3 = sb3.toString();
                ...
                Log.v(MotionLayout.TAG, str2 + "  " + name + " " + constraintWidget + " " + string3);
            }
    ...
    private class DevModeDraw {
        ...
        private void drawPathCartesianTicks(Canvas canvas, float x, float y) {
            ...
            String str = "" + (((int) (((double) ((fMin2 * 100.0f) / Math.abs(f3 - f))) + 0.5d)) / 100.0f);
            getTextBounds(str, this.mTextPaint);
            ...
            String str2 = "" + (((int) (((double) ((fMax2 * 100.0f) / Math.abs(f4 - f2))) + 0.5d)) / 100.0f);
        ...
        private void drawPathScreenTicks(Canvas canvas, float x, float y, int viewWidth, int viewHeight) {
            String str = "" + (((int) (((double) (((x - (viewWidth / 2)) * 100.0f) / (MotionLayout.this.getWidth() - viewWidth))) + 0.5d)) / 100.0f);
            getTextBounds(str, this.mTextPaint);
            ...
            String str2 = "" + (((int) (((double) (((y - (viewHeight / 2)) * 100.0f) / (MotionLayout.this.getHeight() - viewHeight))) + 0.5d)) / 100.0f);
            getTextBounds(str2, this.mTextPaint);
            canvas.drawText(str2, 5.0f + x, 0.0f - ((y / 2.0f) - (this.mBounds.height() / 2)), this.mTextPaint);
  ...
  0x00e2: PHI (r3v50 float) = (r3v49 float), (r3v51 float), (r3v51 float) binds: [B:47:0x00ae, B:58:0x00d6, B:60:0x00da] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    @Override // androidx.constraintlayout.widget.ConstraintLayout, android.view.ViewGroup, android.view.View
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) throws Throwable {
        ...
        try {
            ...
            int i2 = bottom - top;
            try {
                if (motionLayout.mLastLayoutWidth != i || motionLayout.mLastLayoutHeight != i2) {
                    rebuildScene();
                    evaluate(true);
                }
                motionLayout.mLastLayoutWidth = i;
                motionLayout.mLastLayoutHeight = i2;
                motionLayout.mOldWidth = i;
                motionLayout.mOldHeight = i2;
