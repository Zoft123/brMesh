        ...
        if (!hashSet2.isEmpty()) {
            ...
            for (String str : hashSet2) {
                if (str.startsWith("CUSTOM,")) {
                    ...
                    String str2 = str.split(EListUtils.DEFAULT_JOIN_SEPARATOR)[1];
            ...
            for (String str4 : hashSet) {
                if (!this.mTimeCycleAttributesMap.containsKey(str4)) {
                    if (str4.startsWith("CUSTOM,")) {
                        ...
                        String str5 = str4.split(EListUtils.DEFAULT_JOIN_SEPARATOR)[1];
            ...
            while (i15 < i2) {
                if (motionPathsArr[i15].hasCustomData(str10)) {
                    if (dArr4 == null) {
                        dArr3 = new double[i2];
                        int[] iArr3 = new int[2];
                        iArr3[c2] = motionPathsArr[i15].getCustomDataCount(str10);
                        iArr3[0] = i2;
    ...
    boolean interpolate(View child, float global_position, long time, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            if (pathRotate != null) {
                ...
                adjustedPosition = f6;
                pathRotate2 = pathRotate.setPathRotate(view, keyCache, f6, time, dArr3[0], dArr3[1]) | pathRotate2;
            } else {
                view = child;
            }
            int i = 1;
            ...
            view = child;
            float f7 = this.mStartMotionPath.x + ((this.mEndMotionPath.x - this.mStartMotionPath.x) * adjustedPosition);
            float f8 = f7 + 0.5f;
            int i3 = (int) f8;
            float f9 = this.mStartMotionPath.y + ((this.mEndMotionPath.y - this.mStartMotionPath.y) * adjustedPosition) + 0.5f;
            int i4 = (int) f9;
