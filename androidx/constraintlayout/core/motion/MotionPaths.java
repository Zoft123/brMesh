...
public class MotionPaths implements Comparable<MotionPaths> {
    ...
    void initCartesian(MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f10 = f;
        float f11 = (motionPaths2.x + (f4 / 2.0f)) - ((f5 / 2.0f) + f8);
        float f12 = (motionPaths2.y + (f6 / 2.0f)) - (f9 + (f7 / 2.0f));
        ...
        this.y = (int) (((motionPaths.y + (f11 * f16)) + (f12 * f10)) - f14);
    ...
    void initPath(MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f10 = f;
        float f11 = (motionPaths2.x + (motionPaths2.width / 2.0f)) - ((f7 / 2.0f) + f6);
        float f12 = (motionPaths2.y + (motionPaths2.height / 2.0f)) - ((f9 / 2.0f) + f8);
        float f13 = f11 * f10;
    ...
    void setView(float f, MotionWidget motionWidget, int[] iArr, double[] dArr, double[] dArr2, double[] dArr3) {
        ...
        if (motion != null) {
            ...
            motionWidget.setRotationZ((float) (((double) 0.0f) + ((double) f12) + Math.toDegrees(Math.atan2(f7 + (f9 / 2.0f), f6 + (f8 / 2.0f)))));
        }
        float f18 = fSin + 0.5f;
        float f19 = fCos + 0.5f;
