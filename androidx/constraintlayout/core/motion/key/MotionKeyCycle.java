    ...
    public int getId(String str) {
        ...
        switch (str.hashCode()) {
            ...
            case -991726143:
                ...
                break;
            case -987906986:
                b = !str.equals("pivotX") ? (byte) -1 : BSON.REGEX;
                break;
            case -987906985:
                b = !str.equals("pivotY") ? (byte) -1 : BSON.REF;
                break;
            case -908189618:
                b = !str.equals("scaleX") ? (byte) -1 : BSON.CODE;
                break;
            case -908189617:
                b = !str.equals("scaleY") ? (byte) -1 : BSON.SYMBOL;
                break;
            case 92909918:
                b = !str.equals("alpha") ? (byte) -1 : BSON.CODE_W_SCOPE;
                break;
            case 106629499:
                b = !str.equals(TypedValues.CycleType.S_WAVE_PHASE) ? (byte) -1 : BSON.NUMBER_INT;
                break;
            case 579057826:
                b = !str.equals("curveFit") ? (byte) -1 : BSON.TIMESTAMP;
                break;
            case 803192288:
                b = !str.equals("pathRotate") ? (byte) -1 : BSON.NUMBER_LONG;
                break;
            case 1532805160:
