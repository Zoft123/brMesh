...
public class WidgetFrame {
    ...
    public static void interpolate(int i, int i2, WidgetFrame widgetFrame, WidgetFrame widgetFrame2, WidgetFrame widgetFrame3, Transition transition, float f) {
        ...
        int i25 = i18;
        float f7 = widgetFrame3.visibility == 4 ? 0.0f : f5;
        if (widgetFrame.widget == null || !transition.hasPositionKeyframes()) {
            ...
            if (keyPositionFindPreviousPosition != null) {
                i12 = (int) (keyPositionFindPreviousPosition.x * i);
                i7 = (int) (keyPositionFindPreviousPosition.y * i2);
            ...
            if (keyPositionFindNextPosition != null) {
                i14 = (int) (keyPositionFindNextPosition.x * i);
                int i27 = (int) (keyPositionFindNextPosition.y * i2);
        ...
        int i28 = (int) (i9 + ((i8 - i9) * f2));
        widgetFrame.left = i28;
        int i29 = (int) (i7 + (f2 * (i10 - i7)));
        widgetFrame.top = i29;
        float f8 = 1.0f - f;
        widgetFrame.right = i28 + ((int) ((i3 * f8) + (i22 * f)));
        widgetFrame.bottom = i29 + ((int) ((f8 * i23) + (i6 * f)));
        ...
        widgetFrame.alpha = interpolate(f6, f7, 1.0f, f);
