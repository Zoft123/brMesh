...
public class MotionLabel extends View implements FloatLayout {
    ...
    public void layout(float l, float t, float r, float b) {
        ...
        if (this.mAutoSize) {
            ...
            if (fWidth * f4 > fHeight * f3) {
                this.mPaint.setTextSize((this.paintTextSize * f3) / fWidth);
            } else {
                this.mPaint.setTextSize((this.paintTextSize * f4) / fHeight);
            }
    ...
    private void setTypefaceFromAttrs(String familyName, int typefaceIndex, int styleIndex) {
        ...
        if (styleIndex > 0) {
            if (typefaceCreate == null) {
                typefaceCreate2 = Typeface.defaultFromStyle(styleIndex);
            } else {
                typefaceCreate2 = Typeface.create(typefaceCreate, styleIndex);
            }
            setTypeface(typefaceCreate2);
            int i = (~(typefaceCreate2 != null ? typefaceCreate2.getStyle() : 0)) & styleIndex;
