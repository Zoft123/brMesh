...
public class ConstraintSet {
    ...
    */
    ...
    public void clone(ConstraintSet set) {
        ...
        for (Integer num : set.mConstraints.keySet()) {
            Constraint constraint = set.mConstraints.get(num);
            if (constraint != null) {
                this.mConstraints.put(num, constraint.m346clone());
            }
        }
    }
    ...
    */
    ...
    public void parseIntAttributes(Constraint set, String attributes) {
        String[] strArrSplit = attributes.split(EListUtils.DEFAULT_JOIN_SEPARATOR);
    ...
    */
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            switch (overrideMapToConstant.get(index)) {
                ...
                case PATH_MOTION_ARC /* 76 */:
                    delta.add(PATH_MOTION_ARC, a.getInt(index, c.motion.mPathMotionArc));
                    break;
                ...
                case CONSTRAINED_WIDTH /* 80 */:
                    delta.add(CONSTRAINED_WIDTH, a.getBoolean(index, c.layout.constrainedWidth));
                    break;
    ...
    private int[] convertReferenceString(View view, String referenceIdString) {
        ...
        String[] strArrSplit = referenceIdString.split(EListUtils.DEFAULT_JOIN_SEPARATOR);
