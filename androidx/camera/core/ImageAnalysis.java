...
public final class ImageAnalysis extends UseCase {
    ...
    public interface Analyzer {
        ...
        /* JADX INFO: renamed from: androidx.camera.core.ImageAnalysis$Analyzer$-CC, reason: invalid class name */
        public final /* synthetic */ class CC {
            public static Size $default$getDefaultTargetResolution(Analyzer _this) {
                return null;
            }
    ...
    protected UseCaseConfig<?> onMergeConfig(CameraInfoInternal cameraInfoInternal, UseCaseConfig.Builder<?, ?, ?> builder) {
        ...
        if (cameraInfoInternal.getSensorRotationDegrees(((Integer) builder.getMutableConfig().retrieveOption(ImageOutputConfig.OPTION_TARGET_ROTATION, 0)).intValue()) % Opcodes.GETFIELD == 90) {
    ...
    SessionConfig.Builder createPipeline(String str, ImageAnalysisConfig imageAnalysisConfig, StreamSpec streamSpec) {
        ...
        SessionConfig.CloseableErrorListener closeableErrorListener2 = new SessionConfig.CloseableErrorListener(new SessionConfig.ErrorListener() { // from class: androidx.camera.core.ImageAnalysis$$ExternalSyntheticLambda3
            ...
            public final void onError(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
                this.f$0.m168lambda$createPipeline$2$androidxcameracoreImageAnalysis(sessionConfig, sessionError);
            }
        });
    ...
    /* JADX INFO: renamed from: lambda$createPipeline$2$androidx-camera-core-ImageAnalysis, reason: not valid java name */
    /* synthetic */ void m168lambda$createPipeline$2$androidxcameracoreImageAnalysis(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
        if (getCamera() == null) {
            return;
        }
        clearPipeline();
    ...
    private boolean isFlipWH(CameraInternal cameraInternal) {
        return isOutputImageRotationEnabled() && getRelativeRotation(cameraInternal) % Opcodes.GETFIELD != 0;
    }
