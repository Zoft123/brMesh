...
final class SurfaceOutputImpl implements SurfaceOutput {
    ...
    SurfaceOutputImpl(Surface surface, int i, int i2, Size size, SurfaceOutput.CameraInputInfo cameraInputInfo, SurfaceOutput.CameraInputInfo cameraInputInfo2, Matrix matrix) {
        ...
        this.mCloseFuture = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.processing.SurfaceOutputImpl$$ExternalSyntheticLambda0
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f$0.m235lambda$new$0$androidxcameracoreprocessingSurfaceOutputImpl(completer);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$new$0$androidx-camera-core-processing-SurfaceOutputImpl, reason: not valid java name */
    /* synthetic */ Object m235lambda$new$0$androidxcameracoreprocessingSurfaceOutputImpl(CallbackToFutureAdapter.Completer completer) throws Exception {
            ...
            try {
                executor.execute(new Runnable() { // from class: androidx.camera.core.processing.SurfaceOutputImpl$$ExternalSyntheticLambda1
                    ...
                    public final void run() {
                        this.f$0.m236x4fbd8e2d(atomicReference);
                    }
                });
    ...
    /* JADX INFO: renamed from: lambda$requestClose$1$androidx-camera-core-processing-SurfaceOutputImpl, reason: not valid java name */
    /* synthetic */ void m236x4fbd8e2d(AtomicReference atomicReference) {
