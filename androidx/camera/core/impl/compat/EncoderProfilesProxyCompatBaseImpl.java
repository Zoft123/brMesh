...
class EncoderProfilesProxyCompatBaseImpl {
    ...
    private static List<EncoderProfilesProxy.VideoProfileProxy> toVideoProfiles(CamcorderProfile camcorderProfile) {
        ...
        arrayList.add(EncoderProfilesProxy.VideoProfileProxy.create(camcorderProfile.videoCodec, EncoderProfilesProxy.CC.getVideoCodecMimeType(camcorderProfile.videoCodec), camcorderProfile.videoBitRate, camcorderProfile.videoFrameRate, camcorderProfile.videoFrameWidth, camcorderProfile.videoFrameHeight, -1, 8, 0, 0));
        return arrayList;
    }

    private static List<EncoderProfilesProxy.AudioProfileProxy> toAudioProfiles(CamcorderProfile camcorderProfile) {
        ArrayList arrayList = new ArrayList();
        arrayList.add(EncoderProfilesProxy.AudioProfileProxy.create(camcorderProfile.audioCodec, EncoderProfilesProxy.CC.getAudioCodecMimeType(camcorderProfile.audioCodec), camcorderProfile.audioBitRate, camcorderProfile.audioSampleRate, camcorderProfile.audioChannels, EncoderProfilesProxy.CC.getRequiredAudioProfile(camcorderProfile.audioCodec)));
        return arrayList;
    }
