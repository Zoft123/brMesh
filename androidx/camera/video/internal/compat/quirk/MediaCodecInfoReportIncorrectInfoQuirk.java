...
public class MediaCodecInfoReportIncorrectInfoQuirk implements Quirk {
    ...
    public boolean isUnSupportMediaCodecInfo(MediaFormat mediaFormat) {
        ...
        return (isHuaweiMate9() || isRedmiNote8Pro()) ? mediaFormatResolver.isVideo() && mediaFormatResolver.isSize(3840, 2160) : isFHDProblematicDevice() && mediaFormatResolver.isAvc() && mediaFormatResolver.isSize(1920, ResolutionCameraConfig.IMAGE_QUALITY_1080P);
    }
