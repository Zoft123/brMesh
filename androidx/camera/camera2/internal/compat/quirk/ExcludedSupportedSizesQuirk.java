...
public class ExcludedSupportedSizesQuirk implements Quirk {
    ...
    private List<Size> getOnePlus6ExcludedSizes(String str, int i) {
        ...
        if (str.equals(GlobalVariable.ILLUMINATION) && i == 256) {
            arrayList.add(new Size(4160, 3120));
            arrayList.add(new Size(com.king.logx.logger.Logger.MAX_LOG_BYTES, PathInterpolatorCompat.MAX_NUM_POINTS));
        }
        return arrayList;
    }
    ...
    private List<Size> getHuaweiP20LiteExcludedSizes(String str, int i, Class<?> cls) {
        ArrayList arrayList = new ArrayList();
        if (str.equals(GlobalVariable.ILLUMINATION) && (i == 34 || i == 35 || cls != null)) {
    ...
    private List<Size> getSamsungJ7PrimeApi27AboveExcludedSizes(String str, int i, Class<?> cls) {
        ...
        } else if (str.equals(GlobalVariable.RADAR) && (i == 34 || i == 35 || cls != null)) {
            arrayList.add(new Size(3264, 2448));
            arrayList.add(new Size(3264, 1836));
