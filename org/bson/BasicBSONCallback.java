...
public class BasicBSONCallback implements BSONCallback {
    ...
    public void objectStart() {
        ...
        BSONObject bSONObjectCreate = create(false, null);
        this.root = bSONObjectCreate;
        this.stack.add(bSONObjectCreate);
    }

    @Override // org.bson.BSONCallback
    public void objectStart(String str) {
        this.nameStack.addLast(str);
        BSONObject bSONObjectCreate = create(false, this.nameStack);
        this.stack.getLast().put(str, bSONObjectCreate);
        this.stack.addLast(bSONObjectCreate);
    }

    @Override // org.bson.BSONCallback
    public Object objectDone() {
        BSONObject bSONObjectRemoveLast = this.stack.removeLast();
        ...
        return !BSON.hasDecodeHooks() ? bSONObjectRemoveLast : (BSONObject) BSON.applyDecodingHooks(bSONObjectRemoveLast);
    }

    @Override // org.bson.BSONCallback
    public void arrayStart() {
        BSONObject bSONObjectCreate = create(true, null);
        this.root = bSONObjectCreate;
        this.stack.add(bSONObjectCreate);
    }
    ...
    public void arrayStart(String str) {
        this.nameStack.addLast(str);
        BSONObject bSONObjectCreate = create(true, this.nameStack);
        this.stack.getLast().put(str, bSONObjectCreate);
        this.stack.addLast(bSONObjectCreate);
    }
    ...
    protected void _put(String str, Object obj) {
        BSONObject bSONObjectCur = cur();
        if (BSON.hasDecodeHooks()) {
            obj = BSON.applyDecodingHooks(obj);
        }
        bSONObjectCur.put(str, obj);
    }
